...
np.save(os.path.join(SOFT_DIR,'uci_har_soft_all.npy'),soft_all); print("A: ok")
...
np.save(os.path.join(SOFT_DIR,'uci_har_soft_filtered.npy'),soft_filt); print("B: ok")
...
np.save(os.path.join(SOFT_DIR,'uci_har_soft_correct_only.npy'),soft_corr); print("C: ok")
