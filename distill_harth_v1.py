...
def main():
    ...
    result = {
        ...
        "v1_kd": round(ft_acc*100, 2), "v2_vs_v1": round(ft_acc*100-v1_kd, 2),
        "kd_class_acc": ft_ca,
    }
    with open("/home/fandy/workplace/thesis/results/harth_v1.json", "w") as f:
