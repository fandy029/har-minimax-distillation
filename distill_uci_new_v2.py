...
def main():
    ...
    # 软标签
    y_soft = np.load("/home/fandy/workplace/thesis/new_results/uci_har_new_soft.npy")
    ...
    with open("/home/fandy/workplace/thesis/new_results_v2/uci_har_new_v2.json", "w") as f:
